...
""" Note: class Disclosure is altered such that it is possible to force an exogenous strategy distribution in the first period. initial_avoider needs to be set. If initial_avoider = -1, strategies will be chosen in the first round according to PEU only (as described in the paper) """

class Disclosure(Model):
    """A model with some number of agents."""
    def __init__(self, N = 100, scen = 3, audit_discl = 0, blockingfour = 1, kappa = 0.01, complexity = 2.09686, neighbors = 20, rho_upper = 0.1, intr_honest = 0.05, tax_rate = 0.35, initial_avoider = 0.475):
        self.num_nodes = N
        self.scenario = scen
        ...
        self.initial_evader = 1 - self.intrinsically_honest - self.initial_avoider
        ...
        for i, node in enumerate(self.G.nodes()):
            ...
            if self.initial_avoider == -1:
                initial_state = np.random.choice([0,4], p=[self.intrinsically_honest, 1 - self.intrinsically_honest])
            else:
                initial_state = np.random.choice([0,1,2,3], p=[self.intrinsically_honest, 1-self.initial_avoider-self.initial_evader-self.intrinsically_honest, self.initial_avoider, self.initial_evader])
            if initial_state == 0:
...
if __name__ == '__main__':
    ...
    fixed_params = {"N": 1000, "blockingfour": 1, "intr_honest": 0.05, "scen": 1, "audit_discl": 0, "neighbors": 20}
    variable_params = {"initial_avoider": np.arange(0,0.25,0.01)}
    ...
    run_modeldata_df.to_pickle(os.path.join('2_temp_files', 'modeldata_alt_inits_scen1_1.pkl'))


if __name__ == '__main__':

    fixed_params = {"N": 1000, "blockingfour": 1, "intr_honest": 0.05, "scen": 1, "audit_discl": 0, "neighbors": 20}
    variable_params = {"initial_avoider": np.arange(0.25,0.5,0.01)}
    ...
    run_modeldata_df.to_pickle(os.path.join('2_temp_files', 'modeldata_alt_inits_scen1_2.pkl'))


if __name__ == '__main__':

    fixed_params = {"N": 1000, "blockingfour": 1, "intr_honest": 0.05, "scen": 1, "audit_discl": 0, "neighbors": 20}
    variable_params = {"initial_avoider": np.arange(0.5,0.75,0.01)}
    ...
    run_modeldata_df.to_pickle(os.path.join('2_temp_files', 'modeldata_alt_inits_scen1_3.pkl'))
...
if __name__ == '__main__':
    ...
    fixed_params = {"N": 1000, "blockingfour": 1, "intr_honest": 0.05, "scen": 1, "audit_discl": 0, "neighbors": 20}
    variable_params = {"initial_avoider": np.arange(0.75,0.95,0.01)}
    ...
    run_modeldata_df.to_pickle(os.path.join('2_temp_files', 'modeldata_alt_inits_scen1_4.pkl'))
...
if __name__ == '__main__':
    ...
    fixed_params = {"N": 1000, "blockingfour": 1, "intr_honest": 0.05, "scen": 2, "audit_discl": 0, "neighbors": 20}
    variable_params = {"initial_avoider": np.arange(0,0.25,0.01)}
    ...
    run_modeldata_df.to_pickle(os.path.join('2_temp_files', 'modeldata_alt_inits_scen2_1.pkl'))
...
if __name__ == '__main__':
    ...
    run_modeldata_df.to_pickle(os.path.join('2_temp_files', 'modeldata_alt_inits_scen2_2.pkl'))
...
if __name__ == '__main__':
    ...
    run_modeldata_df.to_pickle(os.path.join('2_temp_files', 'modeldata_alt_inits_scen2_3.pkl'))
...
if __name__ == '__main__':
    ...
    run_modeldata_df.to_pickle(os.path.join('2_temp_files', 'modeldata_alt_inits_scen2_4.pkl'))
...
if __name__ == '__main__':
    ...
    fixed_params = {"N": 1000, "blockingfour": 1, "intr_honest": 0.05, "scen": 3, "audit_discl": 1, "neighbors": 20}
    variable_params = {"initial_avoider": np.arange(0,0.25,0.01)}
    ...
    run_modeldata_df.to_pickle(os.path.join('2_temp_files', 'modeldata_alt_inits_scen3_1.pkl'))
...
if __name__ == '__main__':
    ...
    run_modeldata_df.to_pickle(os.path.join('2_temp_files', 'modeldata_alt_inits_scen3_2.pkl'))
...
if __name__ == '__main__':
    ...
    run_modeldata_df.to_pickle(os.path.join('2_temp_files', 'modeldata_alt_inits_scen3_3.pkl'))
...
if __name__ == '__main__':
    ...
    run_modeldata_df.to_pickle(os.path.join('2_temp_files', 'modeldata_alt_inits_scen3_4.pkl'))
